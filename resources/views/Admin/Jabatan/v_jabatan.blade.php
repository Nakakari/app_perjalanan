                        ...
                        <div class="card border-top border-0 border-4 border-primary">
                            <div class="card-body p-5">
                                ...
                                <form class="row g-3" action="/upload/cabang/{{ $c->id_cabang }}" method="POST"
                                    ...
                                    {{ csrf_field() }}
                                    <div class="col-6">
                                        <label for="inputAddress" class="form-label">Kota Tujuan</label>
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, row, meta) {
                    return `<div class="d-flex order-actions">
                            <a href="javascript:;" class="ms-3" data-bs-toggle="modal" data-bs-target="#modalEdit${row.id_jabatan}"><i class='bx bxs-edit'></i></a>
						    </div>`;
                }
                //  <a data-bs-toggle="modal" data-bs-target="#modalDetail"><i class='lni lni-eye'></i></a>
                // <a href="javascript:;" class="ms-3" data-bs-toggle="modal" data-bs-target="#modalHapus${row.id_jabatan}"><i class='bx bxs-trash'></i></a>
            }, ]
        });
    </script>
@stop
